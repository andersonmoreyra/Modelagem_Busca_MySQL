...
CREATE TABLE professor(
    ...
    FOREIGN KEY(codigo_dpto) REFERENCES departamento(codigo)
    );  
...
CREATE TABLE disciplina(  
	...
	ADD COLUMN nome VARCHAR(30) AFTER  codigo;
...
-- Criar tabela pre-req    
CREATE TABLE pre_req(
	codigo_disciplina INT NOT NULL, 
    codigo_disciplina_dependencia INT NOT NULL,
    FOREIGN KEY(codigo_disciplina) REFERENCES disciplina(codigo),
    FOREIGN KEY(codigo_disciplina_dependencia) REFERENCES disciplina(codigo) 
	);
...
(nome,endereco, telefone, data_nasc, codigo_dpto, data_contratacao)
VALUES
...
-- Inserção de dados dos Cursos
ALTER TABLE curso AUTO_INCREMENT = 1;
INSERT INTO curso 
(nome, descricao, codigo_dpto)
VALUES
...
('Ciência da Computação', 'Lógica de Programação com linguagem Python e cálculos matemáticos básicos, Banco de Dados e
...
('Gestão Comercial', 'Administração e desenvolvimento de propagandas, vendas, gestão de projetos comerciais e liderança de
equipe.', 2),
...
-- Inserção de dados das Matriculas
...
(6,'74174171444', '2017/03/01');
 ...
 -- Inserção de dados das Disciplinas   
ALTER TABLE disciplina AUTO_INCREMENT = 1;
INSERT INTO disciplina 
(nome, qtde_creditos, matricula_professor)
values
('Cálculo 1', 2, 5),
('Cálculo 2', 3, 1),
('Probabilidade', 4, 8),
...
('Francês Avançado', 4, 7);   
 ...
 -- Inserção de dados tabela Cursa 
...
-- Inserção dos dados da tabela pre_req
...
-- Inserção dos dados da tabela compoe
